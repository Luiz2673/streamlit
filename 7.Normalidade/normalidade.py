    ...
    try:
        ...
        if data.empty or data.iloc[:,0].isnull().all():
            ...
            if shapiro_test.pvalue > 0.05:
                st.success("Não existe evicências suficientes para rejeitar a hipótese de normalidade dos dados")
            else:
                st.warning("Existem evidências suficientes para rejeitar a hipótese dos dados")
